...
def upgrade() -> None:
    # 1. Add lifecycle fields to memory_items
    op.add_column(
        "memory_items",
    ...
    # 2. Create memory_summaries table (compacted session summaries)
    op.create_table(
        "memory_summaries",
    ...
    # 3. Create memory_extraction_batches table (tracks processed batches)
    op.create_table(
    ...
    # 4. Ensure embedding_vector index exists (from a001)
