...
class ReactionEngine:
    ...
    def __init__(self) -> None:
        ...
        self._reaction_patterns: dict[str, list[str]] = {
            ...
            "🐾": [
                # Пёсья реакция — когда зовут по имени или говорят про собак
                r"(?:псина|п[её]с|п[её]сик|собак|четвероног|лохмат)",
            ],
            "💀": [
                # Когда оскорбляют или угрожают
                r"(?:убью|сотру|удалю|застра?лю|похорон|дохл|сдох|убить)",
            ],
        }
