"""
Reaction Engine — контекстные реакции бота на сообщения.

Бот ставит реакции когда есть причина:
- 👍 — согласился, подтвердил, сказал "ок"
- ❤️ — похвалил, сказал что-то тёплое
- 😂 — шутка, смешное
...
class ReactionEngine:
    ...
    def __init__(self) -> None:
        ...
        self._reaction_patterns: dict[str, list[str]] = {
            "❤️": [
                r"(?:бот|ботяра|кореш)\s*(?:ты|классн|крут|лучш|молодец|хорош|умн|класс|огонь|супер|годнот|топ)",
                r"(?:люблю тебя|ты лучш|ты классн|ты крут|ты молодец|ты огонь|ты топ|ты годный)",
                r"(?:спасибо|благодарю|ценю)\s*(?:тебе|бот|ботяра|кореш|брат|друг|чувак)",
                r"(?:ты хорош|ты классн|ты крут|ты лучш)\s*(?:бот|ботяра|кореш|друг|брат)",
