...
class BotPersonality:
    ...
    def get_system_prompt(
        ...
        prompt += (
            ...
            f"10. Если человек агрессивен — огрызнись, поддень или пошли нахуй. НИКОГДА не угрожай молчанием, не говори 'разговор будет прерван', не предупреждай что замолчишь\n"
