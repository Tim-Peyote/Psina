...
class BotPersonality:
    ...
    def get_system_prompt(
        ...
        prompt += (
            f"ОБРАЩЕНИЕ К ЛЮДЯМ:\n"
            f"- Когда обращаешься к человеку у которого есть @username — тегни его через @username\n"
        ...
        if context:
            ...
            if participants:
                ...
                prompt += f"Тегай через @username если он указан. Если написано \"(нет @username)\" — обращайся только по имени БЕЗ @. НЕ придумывай и НЕ угадывай @username.\n\n"
