...
class SkillRegistry:
    ...
    def _get_default_triggers(self, slug: str) -> list[str]:
        ...
        trigger_map = {
            "agent_rpg": [
                "rpg", "играть", "игра", "давай сыграем", "dnd", "подземелья", "драконы",
                "ролевая", "сессия", "бросок", "кубик", "персонаж", "хочу сыграть",
                "начни игру", "начнём кампанию", "game master",
            ],
            "agent_notes": [
                "запомни", "запиши", "заметка", "записать", "сохрани это",
                "покажи заметки", "список заметок", "что записано",
            ],
            "agent_reminders": [
                "напомни", "напоминание", "напоминалка", "поставь будильник",
                "не забудь напомнить", "через n минут", "remind",
            ],
        }
