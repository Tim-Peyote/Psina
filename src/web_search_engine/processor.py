...
class SearchProcessor:
    ...
    async def _generate_answer(self, query: str, results: list[SearchResult]) -> str:
        ...
        system_prompt = (
            ...
            "СТРОГОЕ ПРАВИЛО ПРО ССЫЛКИ: включай в раздел Источники ТОЛЬКО те URL которые явно присутствуют в результатах поиска выше. "
            "НИКОГДА не пиши URL из памяти или по догадке — если URL нет в результатах, не пиши его вообще.\n\n"
